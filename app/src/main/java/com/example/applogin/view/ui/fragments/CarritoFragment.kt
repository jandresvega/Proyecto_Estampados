...
import com.example.applogin.databinding.PedidosBinding
import com.example.applogin.view.adapter.pedidosadapter
import com.example.applogin.viewmodel.CarritoListViewModel
...
class CarritoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvProductosCarrito.layoutManager = GridLayoutManager(requireActivity(),1)
        ...
        viewModel.productosModel.observe(viewLifecycleOwner){
            ...
            val adapter = pedidosadapter (productos,childFragmentManager)
